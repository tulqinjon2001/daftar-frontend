      ...
      <div className="max-w-md w-full mx-auto flex flex-col flex-1 mt-10 sm:mt-14">
        ...
        <div className="flex-1 w-full rounded-3xl bg-white dark:bg-slate-800/95 shadow-xl shadow-slate-200/50 dark:shadow-black/20 border border-slate-100 dark:border-slate-700/50 px-6 sm:px-8 py-8 sm:py-10">
          ...
          <div className="flex justify-center mb-5">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-app-primary/15 dark:bg-app-primary/25 ring-2 ring-app-primary/25 dark:ring-app-primary/35 shadow-inner">
              <svg
                width="32"
                height="32"
                viewBox="0 0 24 24"
          ...
          <h1 className="text-center text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100 mb-8">
            {t("appName")}
          </h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            {successMessage && (
              <p className="text-app-primary-dark dark:text-app-primary text-sm mb-4 bg-app-primary/10 dark:bg-app-primary/20 py-3 px-4 rounded-xl border border-app-primary/25 dark:border-app-primary/35" role="status">
                {successMessage}
              </p>
            )}
            {error && (
              <p className="text-red-600 dark:text-red-400 text-sm mb-4 bg-red-50 dark:bg-red-900/20 py-3 px-4 rounded-xl" role="alert">
                {error}
              </p>
            )}
            ...
            <div className="flex items-center bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 rounded-xl px-4 py-3 mb-4 focus-within:ring-2 focus-within:ring-app-primary/40 focus-within:border-app-primary dark:focus-within:border-app-primary transition-shadow">
              ...
              <input
                ...
                className="flex-1 min-w-0 ml-2 py-0.5 text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:outline-none bg-transparent font-medium"
              />
            </div>
            ...
            <div className="flex items-center bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 rounded-xl px-4 py-3 mb-3 focus-within:ring-2 focus-within:ring-app-primary/40 focus-within:border-app-primary dark:focus-within:border-app-primary transition-shadow">
              <svg
                className="w-5 h-5 text-slate-400 dark:text-slate-500 mr-3 shrink-0"
                fill="none"
                stroke="currentColor"
              ...
              <input
                ...
                className="flex-1 min-w-0 py-0.5 text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:outline-none bg-transparent font-medium"
              />
              <button
                type="button"
            ...
            <div className="flex justify-end mb-10 mt-2">
              <Link
                to="/forgot-password"
                className="text-sm font-semibold text-app-primary hover:text-app-primary-dark dark:hover:text-app-primary hover:underline transition-colors"
              >
                {t("forgotPassword")}
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 rounded-xl font-bold text-white shadow-lg shadow-app-primary/25 hover:brightness-105 active:scale-[0.98] transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed bg-app-primary"
            >
